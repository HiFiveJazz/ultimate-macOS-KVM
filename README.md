...
The easiest way to do this is by grabbing some mainstream Linux distributions, like **Ubuntu, Linux Mint, Manjaro, EndeavourOS** - among many, many others. You can theoretically pick any one you like. *I use Arch BTW.*
